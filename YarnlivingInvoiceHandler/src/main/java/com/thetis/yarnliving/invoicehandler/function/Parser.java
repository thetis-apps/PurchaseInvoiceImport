...
import com.thetis.ims.client.MapperImpl;
import com.thetis.ims.client.ThetisIMS;
import com.thetis.ims.client.model.EventMessage;
import com.thetis.ims.client.model.GlobalTradeItem;
import com.thetis.ims.client.model.InboundShipment;
import com.thetis.ims.client.model.InboundShipmentLine;
...
public class Parser implements RequestHandler<SNSEvent, String> {
	...
	private ThetisIMS ims = new ThetisIMS(mapper);
        ...
        try {
	        ...
	        for (SNSRecord message : input.getRecords()) {
	            ...
	            while (!finished) {
 				...
 				InboundShipment inboundShipment = ims.get("inboundShipments", inboundShipmentId, InboundShipment.class);
	            ...
	            for (Line line : invoice.getLines()) { 
	            	...
	            	while (!found && iterator.hasNext()) {
	            		...
	            		String suppliersItemNumber = inboundShipmentLine.getBusinessItemNumber();
	            	...
	            	if (found) {
	            		...
	            		GlobalTradeItem globalTradeItem = ims.get("globalTradeItems", inboundShipmentLine.getGlobalTradeItemId(), GlobalTradeItem.class);
	            		
	            		Long numUnitsContained = globalTradeItem.getNumUnitsContained() != null ? globalTradeItem.getNumUnitsContained() : 1;
	            		Long unitOfPurchase = 1L; // Here use logistic variants - Previous: globalTradeItem.getUnitOfPurchase() != null ? globalTradeItem.getUnitOfPurchase() : 1;
	            		...
	            		if (numItemsExpected == null || qty != inboundShipmentLine.getNumItemsExpected()) {
            				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "numItemsExpected", qty, InboundShipmentLine.class);
	            		}
	            		
	            		BigDecimal purchasePrice = inboundShipmentLine.getPurchasePrice();
						if (purchasePrice == null || !purchasePrice.equals(price)) {
            				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "purchasePrice", price, InboundShipmentLine.class);
	            		}
						...
						if (discount.compareTo(BigDecimal.ZERO) > 0) {
            				...
            				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "discountPercentage", discountPercentage, InboundShipmentLine.class);
	            		}
						
        				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "suppliersDescription", line.getPageNumber() * 1000 + line.getLineNumber(), InboundShipmentLine.class);
			            ...
			            ims.post("events", eventId, "messages", eventMessage);
	            ...
	            for (InboundShipmentLine inboundShipmentLine : inboundShipmentLines) {
    				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "numItemsExpected", 0L, InboundShipmentLine.class);
    				ims.put("inboundShipmentLines", inboundShipmentLine.getId(), "suppliersDescription", "", InboundShipmentLine.class);
	            }
